...
I have seen a few posts about getting the battery level of Bluetooth device in Home-Assistant but none of them actually fully explain and none of them actually worked for me at first.

1. First open the Home-Assistant app on your phone and navigate to Settings > Companion App > Manage Sensors > Last Update Trigger.
...
5. ***IMPORTANT***: Restart the app, it is important that you perform a forced restart (there will be a button in your phones settings on the Home-Assistant app info page that will say something along the lines of `Force stop`).
...
9. Either restart Home-Assistant or open the developer tools page and click reload template entities.
10. You did it!
